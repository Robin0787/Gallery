...
const UploadImage = () => {
    return (
        ...
        <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-full border-2 border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer bg-transparent hover:bg-inherit duration-500 group">
